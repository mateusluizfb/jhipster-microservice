...
import gateway.app.config.audit.AuditEventConverter;
import gateway.app.domain.PersistentAuditEvent;
...
import static gateway.app.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
